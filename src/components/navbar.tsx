            ...
            {isOpen && (
                <div className="md:hidden bg-white border-t border-gray-200 shadow-md">
                    <div className="flex flex-col items-center space-y-4 py-6 text-gray-700 font-medium">
                        ...
                        <Link href="#pricing" onClick={toggleMenu} className="hover:text-blue-600">Cennik</Link>
                        <Link href="#gallery" onClick={toggleMenu} className="hover:text-blue-600">Galeria</Link>
                        <Link href="#contact" onClick={toggleMenu} className="hover:text-blue-600">Kontakt</Link>
                    </div>
                </div>
            )}
        </nav>
